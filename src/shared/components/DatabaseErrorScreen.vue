...
<template>
  <main
    ...
    <section aria-live="assertive" aria-label="Loi ket noi database"
      ...
      <div class="flex items-center gap-2">
        <Button icon="pi pi-cog" label="Cấu hình lại" severity="secondary" outlined
        ...
        <Button :icon="database.isChecking.value ? 'pi pi-spinner pi-spin' : undefined"
          :label="database.isChecking.value ? 'Đang kiểm tra...' : 'Thử lại'" :disabled="database.isChecking.value"
